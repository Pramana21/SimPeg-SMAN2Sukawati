...
<div class="space-y-6">
    <div>
        ...
        <p class="mt-2 text-sm text-slate-500">Kelola seluruh dokumen keuangan dengan filter, checkbox, dan aksi yang seragam dengan modul lain.</p>
    </div>
    ...
    <div class="rounded-[28px] border border-slate-200 bg-white/90 p-5 shadow-sm">
        <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            <div class="flex flex-wrap items-center gap-3">
                <form method="GET" action="{{ route('keuangan.index') }}" class="flex flex-wrap items-center gap-3">
                    <div class="relative">
                        <select name="bulan"
        ...
        @include('admin.keuangan.partials.table', [
            'tableId' => 'keuanganOverview',
            'emptyMessage' => 'Data keuangan belum tersedia untuk filter yang dipilih.',
            'showCategory' => true,
        ])
    </div>
</div>
