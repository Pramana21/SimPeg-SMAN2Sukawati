...
<div class="space-y-6">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-4xl font-semibold text-slate-900">Edit Data Siswa</h1>
            <p class="mt-1 text-sm text-slate-500">Perbarui data murid dan lihat preview foto sebelum menyimpan perubahan.</p>
        </div>
    </div>
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <input id="nama_siswa" type="text" name="nama_siswa"
                               value="{{ old('nama_siswa', $murid->nama_siswa) }}"
                    ...
                    <div>
                        ...
                        <input id="nama_ibu_kandung" type="text" name="nama_ibu_kandung"
                               value="{{ old('nama_ibu_kandung', $murid->nama_ibu_kandung) }}"
                               class="w-full rounded-lg border border-slate-200 px-4 py-3 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                        ...
                        <label for="fotoInput"
                            ...
                            <p id="fotoStatus" class="mt-3 text-sm font-semibold text-blue-600">
                                {{ $murid->foto_path ? basename($murid->foto_path) : 'Belum ada file dipilih' }}
                            </p>
                        </label>
                    </div>
...
<script>
    (function () {
        ...
        fotoInput.addEventListener('change', function (e) {
            ...
            if (!file) {
                showExistingPreview();
                fotoStatus.textContent = existingPhotoSrc ? '{{ $murid->foto_path ? basename($murid->foto_path) : 'Belum ada file dipilih' }}' : 'Belum ada file dipilih';
                return;
            }
