...
<div class="max-w-4xl space-y-6">
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">Tambahkan dokumen pegawai dengan jenis dokumen yang sesuai.</p>
        </div>
    </div>
    ...
    <form action="{{ route('administrasi.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        <input type="hidden" name="selected_kategori" value="Pegawai">
